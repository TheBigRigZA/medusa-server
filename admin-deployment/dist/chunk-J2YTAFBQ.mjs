          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-list-3BX3VC5Z.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-IOUVWT2V.mjs")
                    },
                    {
                      path: "import",
                    ...
                    {
                      path: "export",
                      lazy: () => import("./product-export-NPFJY4RR.mjs")
                    }
                  ]
                },
                {
                  ...
                  errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-7SYPNV46.mjs");
                    return {
                      Component: Outlet4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-7SYPNV46.mjs"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-IRCPTLOM.mjs")
                        },
                        {
                          path: "edit-variant",
                        ...
                        {
                          path: "sales-channels",
                          lazy: () => import("./product-sales-channels-5MBRVBUA.mjs")
                        },
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-ISNJWWAS.mjs")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-EM5BESRO.mjs")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-OXAWSBWM.mjs")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-YHTR6C2U.mjs")
                        },
                        {
                          path: "prices",
                        ...
                        },
                        {
                          ...
                          lazy: () => import("./product-create-variant-V4NS5XBV.mjs")
                        },
                        {
                          path: "stock",
                    ...
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component, Breadcrumb, loader } = await import("./product-variant-detail-55KFPDMG.mjs");
                        return {
                          Component,
                          loader,
                          handle: {
                      ...
                      children: [
                        ...
                        {
                          path: "manage-items",
                          lazy: () => import("./product-variant-manage-inventory-items-3N2VMXZ2.mjs")
                        },
                        {
                          path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./category-list-MQHLYJXA.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./category-detail-H2HCRNYM.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "products",
                      lazy: () => import("./category-products-3D6UYLKN.mjs")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-W34LC4TR.mjs")
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./order-list-4PSER6N3.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./order-detail-NMFEZ75D.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "returns",
                      lazy: () => import("./order-create-return-7V7F3M2X.mjs")
                    },
                    {
                      path: "claims",
                      lazy: () => import("./order-create-claim-KU4WDC62.mjs")
                    },
                    {
                      path: "exchanges",
                      lazy: () => import("./order-create-exchange-ENWLOL4T.mjs")
                    },
                    {
                      path: "edits",
                      lazy: () => import("./order-create-edit-2PCJPVAT.mjs")
                    },
                    {
                      path: "refund",
                      lazy: () => import("./order-create-refund-V5YDN6HL.mjs")
                    },
                    {
                      path: "transfer",
                      lazy: () => import("./order-request-transfer-J7ODRRXB.mjs")
                    },
                    {
                      path: "email",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-QMGVNMSO.mjs")
                },
                {
                  path: "create",
                  lazy: () => import("./promotion-create-7LABGQBH.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./promotion-detail-OAQR3XXI.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./campaign-detail-52JPO4E2.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-ZNEHC5EA.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./collection-list-QVHGMXD5.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./collection-detail-WZSWQ6FK.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "products",
                      lazy: () => import("./collection-add-products-EJVE6WYZ.mjs")
                    },
                    {
                      path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./price-list-list-QCKY775P.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./price-list-create-JCWRKCPC.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./price-list-detail-OEQHULBH.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "configuration",
                      lazy: () => import("./price-list-configuration-V2VLJ6YR.mjs")
                    },
                    {
                      path: "products/add",
                      lazy: () => import("./price-list-prices-add-PX5SNGZ3.mjs")
                    },
                    {
                      path: "products/edit",
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./customer-detail-FWPALL3L.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      lazy: () => import("./customers-add-customer-group-QLSR3XFC.mjs")
                    },
                    {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-group-list-HB74KV5M.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./customer-group-detail-YRYYSH2A.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./reservation-list-RB5WZU6X.mjs"),
                  children: [
                    {
                      path: "create",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./inventory-list-QGRW7KN4.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./inventory-detail-RTPEQRJE.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
      ...
      children: [
        {
          ...
          children: [
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./region-create-L6YIMW4X.mjs")
                    }
                  ]
                },
                {
            ...
            },
            {
              path: "store",
              errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
              lazy: () => import("./store-detail-T5YBEUMC.mjs"),
              handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./sales-channel-list-45WEQT3Q.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./sales-channel-detail-UW5MEQKY.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-products",
                      lazy: () => import("./sales-channel-add-products-QF5FJXYZ.mjs")
                    },
                    {
                      path: "metadata/edit",
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    ...
                    {
                      path: "sales-channels",
                      lazy: () => import("./location-sales-channels-SPTFS6QG.mjs")
                    },
                    {
                      path: "fulfillment-providers",
                      lazy: () => import("./location-fulfillment-providers-5O44NW4Y.mjs")
                    },
                    {
                          ...
                          children: [
                            ...
                            },
                            {
                              ...
                              children: [
                                {
                                  path: "create",
                                  lazy: () => import("./location-service-zone-shipping-option-create-QZB7VQFP.mjs")
                                },
                                {
                                  path: ":so_id",
                                  children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-tag-list-WWEGZXQK.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./product-tag-detail-PRPSGM26.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./product-type-detail-B5ROLSWV.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./api-key-management-list-3C3TAO2E.mjs"),
                      children: [
                        {
                          path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./api-key-management-detail-ORIRNM72.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "sales-channels",
                      lazy: () => import("./api-key-management-sales-channels-4KMVBDFS.mjs")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-4CMH7BY2.mjs")
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      ...
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./tax-region-edit-GHZ22EEA.mjs")
                        },
                        {
                        ...
                        },
                        {
                          ...
                          lazy: () => import("./tax-region-tax-override-create-ISUSDFMS.mjs")
                        },
                        {
                          path: "overrides/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-override-edit-QTB2IOOB.mjs")
                        },
                        {
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-UUL5N3DT.mjs")
            },
            {
              path: "/invite",
